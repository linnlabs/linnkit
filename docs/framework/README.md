...
├── 16-refactor-and-benchmark-baseline-plan.md   # Q-R 根因重构收官 + benchmark 自动化入口
...
4. `14-governance-and-cleanup-plan.md` / `15-robustness-and-decoupling-audit.md` / `16-refactor-and-benchmark-baseline-plan.md` —— 看当前治理结论与下一站 benchmark
...
> **权威状态源（2026-08-09 发布校准）**：实际版本已达 **`0.28.0`**——版本变化以 [`CHANGELOG.md`](../../CHANGELOG.md) 为准；治理收官索引见 [`14-governance-and-cleanup-plan.md`](./14-governance-and-cleanup-plan.md)，质量治理收官见 [`15`](./15-robustness-and-decoupling-audit.md)，下一站 benchmark 自动化入口见 [`16`](./16-refactor-and-benchmark-baseline-plan.md)。下表是阶段级历史台账，状态列已按真实代码校准。
